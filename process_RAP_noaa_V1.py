...
data_directory = '/scratch2/BMC/gsd-hpcs/Christina.E.Kumler/machine_learning/frp_project/polar_orbitors/NOAA-20/fire_pda/'
out_directory = '/scratch2/BMC/gsd-hpcs/Christina.E.Kumler/machine_learning/frp_project/noaa_rap_processed'

#rap_directory = '/Users/christina.bonfanti/Documents/machine_learning/FRP/proc_local_RAP_polar/RAP/'
#data_directory = '/Users/christina.bonfanti/Documents/machine_learning/FRP/proc_local_RAP_polar/polar/'
#out_directory = '/Users/christina.bonfanti/Documents/machine_learning/FRP/proc_local_RAP_polar/processed_jpss/'
...
def gatherRAPandPOLAR(time, rap_f, jpss_f):
...
#        jpss_ds = pd.read_csv('/Users/christina.bonfanti/Documents/machine_learning/FRP/proc_local_RAP_polar/polar/AF_v1r1_j01_s201808201654476_e201808201656103_c201808201806410.txt')
#        rap_lat_lon = pd.read_csv('concat_lat_lon_RAP.csv')
        ...
        frp_lat = jpss_ds['lat']
        # HERE YOU NEED TO ACCOUNT FOR POLAR ORBITORS THAT ARE NEGATIVE - SHOULD BE NAN
#        if frp_lat[ind] < 0:
#            frp_lat[ind] = float("NAN")
        # HERE YOU CAN UNCOMMENT AND FORCE LATS TO BE IN NH FOR TESTING PURPOSES
#        frp_lat = np.abs(frp_lat)
        frp_lon = jpss_ds['lon']
 ...
 #           print("I went into first = 0 ")  
            ...
            if np.isnan(rap_close):
                ...
                data_df = pd.DataFrame({"lat": grbs[1].latitudes[rap_close],
                                        ...
                                        "FRP": jpss_ds['frp'][ind],
                                        "bright_t13": jpss_ds['bright_t13'][ind],
                                        "confidence": jpss_ds['confidence'][ind],
                                        "mask": jpss_ds['mask'][ind],
                                        "id": rap_close,
                                        "sat": 'noaa',
...
def main():
    ...
    for f in sorted_dir:
        f_date_string = f[-36:-24]
        date = datetime.datetime.strptime(f_date_string, "%Y%m%d%H%M")
        ...
        print('remember date :', date_remember)
        print('file name: ', f)
